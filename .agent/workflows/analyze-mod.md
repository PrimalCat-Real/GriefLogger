---
description: Анализирует исходный код мода для поиска логики работы с предметами и блоками
---
...
## Использование
Данный workflow будет запущен по запросу пользователя. Пользователь должен указать путь к исходникам мода для анализа.

## Пример
`Проанализируй мод по пути C:\Projects\mods\Create`
...
### 3. Формат вывода
Создай артефакт с таблицей в формате:
